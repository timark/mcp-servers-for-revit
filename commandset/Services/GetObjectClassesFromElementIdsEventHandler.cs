...
{
    public class GetObjectClassesFromElementIdsEventHandler : IExternalEventHandler, IWaitableExternalEventHandler
    {
        ...
        public string GetName() => "Get Object Classes From ElementIds";
    }
}
